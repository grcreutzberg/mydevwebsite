...
export default class leroLero extends Component {
    ...
    gerarLeroLero = () => {
        const txtResult = this.lerolero();
        this.setState({ lerolero: txtResult });
    }

    lerolero = () => {
        return (
            this.randomItem(txt0) +
            this.randomItem(txt1) +
            this.randomItem(txt2) +
            this.randomItem(txt3)
        )
    }
    ...
    render() {
        return (
            <div className="lero-form">
                <h2>Lero lero</h2>
                <p>Lero lero, gerador de frases aleatórias</p>
                <div className="lero-div">
                    <h3>Lero lero</h3>
                    <br />
                    <textarea
                        id="leroLero"
                        placeholder="Lero lero..."
                        value={this.state.lerolero}
                        readOnly={true}
                        rows="10"
                        cols="50">
                    </textarea>
                    <br />
                    <button onClick={this.gerarLeroLero}>Gerar!</button>
                </div>
            </div>
        );
    }
